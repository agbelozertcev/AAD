...
<!-- ********************* RadioButtons Style  ********************-->
 ...
 <!-- -->
     ...
     <ListView x:Name="Groups_lv_d" Grid.Column="1"  FontSize="12"  ItemsSource="{Binding}" IsSynchronizedWithCurrentItem="True" ScrollViewer.CanContentScroll="True"  HorizontalAlignment="Stretch" VerticalAlignment="Top" >
         <ListView.Resources>
             <Style TargetType="{x:Type GridViewColumnHeader}">
                <!-- <Setter Property="HorizontalContentAlignment" Value="Left"/> -->
                 <Setter Property="Background" Value="SteelBlue"/>
